...
def create_args():
    ...
    # --- Input paths ---
    parser.add_argument('--input_path', default="../data/11_tracks.csv", type=str,
                        help='CSV file of the tracks')
    parser.add_argument('--input_static_path', default="../data/11_tracksMeta.csv",
                        type=str,
                        help='Static meta data file for each track')
    parser.add_argument('--input_meta_path', default="../data/11_recordingMeta.csv",
                        type=str,
                        help='Static meta data file for the whole video')
    parser.add_argument('--pickle_path', default="../data/11.pickle", type=str,
    ...
    parser.add_argument('--background_image', default="../data/11_highway.jpg", type=str,
